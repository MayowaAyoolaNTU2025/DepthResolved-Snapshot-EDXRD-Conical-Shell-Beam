...
dataFolder = 'C:\Users\padra\Desktop\MATLABMcXtrace\SampleMaterial\Si_15mm_750nE';
...
ylabel('d-spacing (Å)');
title('d-spacing vs Sample Distance (Si.laz)');
xlim([80 180]);
...
title('1D Diffractogram for Si.laz');

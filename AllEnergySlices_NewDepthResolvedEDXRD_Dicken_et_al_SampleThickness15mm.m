...
dataFolder = 'C:\Users\padra\Desktop\MATLABMcXtrace\SampleThickness\15mm';
...
axis image;
colorbar;
title('Intensity Image (Si.laz - 15 mm)');
xlim([20 60]);
ylim([20 60]);
xticks(20:20:60);
yticks(20:20:60);
...
ylabel('d-spacing (Å)');
title('d-spacing vs Sample Distance (Si.laz - 15 mm)');
xlim([80 180]);
...
title('1D Diffractogram (Si.laz - 15 mm)');

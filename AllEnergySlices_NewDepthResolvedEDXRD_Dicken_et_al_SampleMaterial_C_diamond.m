...
dataFolder = 'C:\Users\padra\Desktop\MATLABMcXtrace\SampleMaterial\C_diamond_15mm_750nE';
...
axis image;
colorbar;
title('Intensity Image (C\_diamond.laz)');
xlim([20 60]);
ylim([20 60]);
xticks(20:20:60);
yticks(20:20:60);
...
ylabel('d-spacing (Å)');
title('d-spacing vs Sample Distance (C\_diamond.laz)');
xlim([80 180]);
...
title('1D Diffractogram (C\_diamond.laz)');
